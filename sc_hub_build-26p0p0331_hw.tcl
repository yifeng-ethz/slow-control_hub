################################################
# sc_hub "Slow Control Hub" 26.0.0331
# Yifeng Wang
################################################

package require -exact qsys 16.1

set_module_property DESCRIPTION "Legacy slow control hub snapshot preserved for Platform Designer regeneration."
set_module_property NAME sc_hub
set_module_property VERSION 26.0.331
...
add_fileset_file legacy/v26_0_0331/sc_hub.vhd VHDL PATH legacy/v26_0_0331/sc_hub.vhd
add_fileset_file legacy/v26_0_0331/alt_ip/alt_fifo_w32d256/alt_fifo_w32d256.vhd VHDL PATH legacy/v26_0_0331/alt_ip/alt_fifo_w32d256/alt_fifo_w32d256.vhd
add_fileset_file legacy/v26_0_0331/alt_ip/alt_fifo_w40d512/alt_fifo_w40d512.vhd VHDL PATH legacy/v26_0_0331/alt_ip/alt_fifo_w40d512/alt_fifo_w40d512.vhd
add_fileset_file legacy/v26_0_0331/sc_hub_top.vhd VHDL PATH legacy/v26_0_0331/sc_hub_top.vhd TOP_LEVEL_FILE
...
add_parameter MASTER_BUS_TYPE STRING {Avalon}
set_parameter_property MASTER_BUS_TYPE DEFAULT_VALUE {Avalon}
set_parameter_property MASTER_BUS_TYPE DISPLAY_NAME "Master Bus Type"
set_parameter_property MASTER_BUS_TYPE TYPE STRING
set_parameter_property MASTER_BUS_TYPE UNITS None
set_parameter_property MASTER_BUS_TYPE ALLOWED_RANGES {"Avalon" "AXI4"}
set_parameter_property MASTER_BUS_TYPE HDL_PARAMETER false
...
set_interface_property hub_avmm maximumPendingReadTransactions 1
set_interface_property hub_avmm maximumPendingWriteTransactions 1
set_interface_property hub_avmm readLatency 0
set_interface_property hub_avmm readWaitTime 1
set_interface_property hub_avmm registerIncomingSignals true
