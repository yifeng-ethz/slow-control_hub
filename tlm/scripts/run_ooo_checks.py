...
from tests.ooo.checks import CHECKS, run_checks


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run OoO correctness checks")
    ...
    append_rows(Path(args.csv_dir) / "ooo_correctness.csv", rows)
    for row in rows:
