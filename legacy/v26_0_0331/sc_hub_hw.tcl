...
set_module_property DESCRIPTION "Slow control hub which couples slow-control packets to the datapath entities"
...
add_fileset_file alt_ip/alt_fifo_w32d256/alt_fifo_w32d256.vhd VHDL PATH alt_ip/alt_fifo_w32d256/alt_fifo_w32d256.vhd
add_fileset_file alt_ip/alt_fifo_w40d512/alt_fifo_w40d512.vhd VHDL PATH alt_ip/alt_fifo_w40d512/alt_fifo_w40d512.vhd
...
proc my_elaborate {} {
    if {[string equal -nocase [get_parameter_value MASTER_BUS_TYPE] "AXI4"]} {
        send_message ERROR "AXI4 master interface is not implemented yet; use Avalon for the live sc_hub RTL"
    } else {
        send_message INFO "sc_hub master interface type: Avalon"
    }
}
