...
-- =======================================
-- Revision: 3.1 (add explicit upload/download FIFO telemetry and hub-managed FIFO controls)
--     Date: Mar 31, 2026
-- =========
...
begin
    ...
    -- Keep ingress direct until the dedicated downlink FIFO forwarding path is revalidated.
    -- The local CSR path in sc_hub is still always reachable because it does not cross AVMM.
