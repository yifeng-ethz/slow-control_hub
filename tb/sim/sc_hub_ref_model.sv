package sc_hub_ref_model_pkg;
  ...
  localparam int unsigned HUB_VERSION_PATCH_CONST    = 9;
  localparam int unsigned HUB_BUILD_CONST            = 12'h414;
  localparam logic [31:0] HUB_VERSION_DATE_CONST     = 32'd20260414;
