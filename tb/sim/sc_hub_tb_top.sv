...
`ifdef SC_HUB_BUS_AXI4
  ...
  axi4_slave_bfm axi4_bfm_inst (
    ...
    .rvalid          (axi_rvalid),
    .rready          (axi_rready),
    .accept_ar_resp_valid(1'b0),
    .accept_ar_resp_code (2'b00),
    .accept_aw_resp_valid(1'b0),
    .accept_aw_resp_code (2'b00),
...
`else
  ...
  avmm_slave_bfm avmm_bfm_inst (
    ...
    .accept_rd_resp_valid (1'b0),
    .accept_rd_resp_code  (2'b00),
    .accept_wr_resp_valid (1'b0),
    .accept_wr_resp_code  (2'b00),
    .inject_rd_error      (inject_rd_error),
    .inject_wr_error      (inject_wr_error),
    .inject_decode_error  (inject_decode_error)
  );
